...
bool apply_csp_preset(std::string_view str, pl_color_space& csp, pl_color_repr& repr, std::string_view* out_fmt = nullptr) noexcept
{
    ...
    static constexpr std::array<csp_preset, 24> presets{{
        ...
        {"dovi", PL_COLOR_PRIM_BT_2020, PL_COLOR_TRC_PQ, PL_COLOR_SYSTEM_DOLBYVISION, PL_COLOR_LEVELS_LIMITED, "YUV420P10"},
        {"dolbyvision", PL_COLOR_PRIM_BT_2020, PL_COLOR_TRC_PQ, PL_COLOR_SYSTEM_DOLBYVISION, PL_COLOR_LEVELS_LIMITED, "YUV420P10"},
